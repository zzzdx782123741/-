...
const Footer: React.FC = () => {
  ...
  return (
    <footer id="footer" className="bg-white dark:bg-[#1C1F26] text-gray-600 dark:text-gray-400 pt-10 pb-8 font-sans snap-start flex flex-col justify-center shadow-[0_-5px_20px_rgba(0,0,0,0.05)] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 w-full">
        <div className="flex flex-col lg:flex-row justify-between gap-6 mb-6">
              ...
              <div key={section.title} className="flex flex-col space-y-4">
                ...
                <ul className="space-y-2">
                  {section.items.map((item) => (
                    <li key={item.label}>
                      <a href={item.href} className="text-gray-600 dark:text-gray-400 hover:text-[#E60012] dark:hover:text-white text-xs transition-colors duration-300">
                        {item.label}
                      </a>
                    </li>
                  ))}
          ...
          {/* Right Brand & Contact */}
          <div className="flex flex-col items-center lg:items-end space-y-6 lg:w-1/3">
            <div className="mb-2">
              <img 
                src="/logo-full.png" 
                alt="万连通 Logo" 
            ...
            <div className="text-center lg:text-right space-y-1">
              <p className="text-gray-600 dark:text-gray-300 font-medium text-sm">电话: <span className="text-[#333333] dark:text-white font-bold text-base">400-015-8686</span></p>
              <p className="text-gray-500 text-[10px]">网站: https://www.10000da.cn</p>
            </div>

            {/* QR Codes */}
            <div className="flex space-x-4 scale-90 origin-right">
              {[
                ...
                >
                  <div className="w-20 h-20 bg-white border border-gray-100 dark:border-transparent p-1 rounded-lg transition-transform duration-300 group-hover:scale-105 shadow-sm">
                    <img 
                  ...
                  <span className="text-[10px] text-gray-500 group-hover:text-[#E60012] dark:group-hover:text-white transition-colors">{qr.name}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col items-center space-y-4 transition-colors duration-300">
